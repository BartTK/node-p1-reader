        ...
        if (lines[i] != "") {
            ...
            switch (line.obisCode) {
                ...
                case "0-0:17.0.0":
                    ...
                    parsedPacket.electricity.threshold.reading = parseFloat(line.value);
                ...
                case "1-0:99.97.0":
                    var powerFailureEventLog = _parsePowerFailureEventLog(line.value);
                    ...
                    for (var j = 0; j < powerFailureEventLog.log.length; j++) {
                        var logItem = {};
                ...
                case "0-4:24.2.1":
                    ...
                    parsedPacket.gas.value.reading = parseFloat(hourlyReading.value);
                    parsedPacket.gas.value.unit = hourlyReading.unit;
                    break;
